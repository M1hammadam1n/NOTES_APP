...
class NoteProvider extends ChangeNotifier {
  ...
  Future<void> changeNote(BuildContext context, int index) async {
    await HiveBoxes.notes
        ...
        //установка значение в поля редактирования
        
        Future<void> setControllers(int index) async{
          titleController.text = HiveBoxes.notes.getAt(index)?.title ??LocaleKeys.title.tr();
          textController.text  = HiveBoxes.notes.getAt(index)?.title ?? LocaleKeys.note.tr();
        }
  }
